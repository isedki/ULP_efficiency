...
output_dir = unique_output_dir('LenMa')  # The output directory of parsing result
...
if __name__ == "__main__":
    ...
    res2 = prepare_results2(os.path.join(input_dir+"/output", 'lenma_efficiency.csv'))
