...
output_dir = unique_output_dir('LogCluster')  # The output directory of parsing result
...
if __name__ == "__main__":
    ...
    res2 = prepare_results2(os.path.join(input_dir+"/output", result_file+'_logclus__accuracy.csv'))
    for dataset in datasets:
        ...
        evaluator(
            ...
            output_dir=output_dir,
            log_file=log_file,
            LogParser=LogCluster.LogParser,
            param_dict={
