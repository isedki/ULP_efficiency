...
class Partition:
    """ Wrap around the logs2 and the step number
    """
...
class Para:
    ...
    Attributes
    ----------
        maxEventLen : the length of the longest log/event, which is used in step 1 to split logs2 into partitions 
            according to their length
        path : the path of the input file
        step2Support : the support threshold to create a new partition, partitions which contains less than 
            step2Support logs2 will not go through step 2
...
class LogParser:
    def __init__(self, log_format, indir='../logs2/', outdir='./result/',
        ...
        # Initialize some partitions which contain logs2 with different length
